...
import { Home, FolderKanban, BarChart3, Wrench } from "lucide-react";
...
function Header() {
    ...
    useEffect(() => {
        if (pathname !== "/") {
            ...
            setActiveSection(activeItem ? activeItem.section : "");
            return;
        }
        ...
        <header className="fixed top-0 left-0 w-full z-[1000]">
            <div className="mx-auto max-w-5xl px-4 py-3 flex justify-center">
                <nav className="flex items-center gap-2 rounded-full px-3 py-2
                    ...
                    backdrop-blur-md dark:bg-zinc-950/70 cursor-pointer">
                    ...
                    {navItems.map((item) => {
                        ...
                        const LinkComponent = isHomePage ? ScrollLink : Link;
                        ...
                        return (
                            ...
                            >
                                ...
                                <span className="pointer-events-none absolute top-[56px] left-1/2 -translate-x-1/2
